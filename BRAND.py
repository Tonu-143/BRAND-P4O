...
def fia():    
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/profile.php?id=100000812025846&mibextid=ZbWKwL);menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def menu():
	os.system('clear')
	print(logo)
	print('\x1b[97;1m[2] Crack random Clone Method 1')
	print('\x1b[97;1m[3] Crack random Clone Method 2')
	linex()
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :017,019,018,016.''\x1b[1;91mETC')
	linex()
